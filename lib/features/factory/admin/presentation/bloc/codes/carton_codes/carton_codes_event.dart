...
abstract class CartonCodesEvent with _$CartonCodesEvent {
  const factory CartonCodesEvent.load({String? codeFormat}) = LoadCartonCodes;
  const factory CartonCodesEvent.generate(CartonCodeGenerationRequest request) =
      GenerateCartonCodes;
  const factory CartonCodesEvent.delete(String cartonCodeId) = DeleteCartonCode;
  const factory CartonCodesEvent.deleteBatch(List<String> cartonCodeIds) =
      DeleteCartonCodeBatch;
  ...
  const factory CartonCodesEvent.filterByFormat(String? codeFormat) =
      FilterCartonCodesByFormat;
  const factory CartonCodesEvent.export(
    List<String> cartonCodeIds,
    String format,
  ) = ExportCartonCodes;
  const factory CartonCodesEvent.select(String cartonCodeId, bool isSelected) =
      SelectCartonCode;
  const factory CartonCodesEvent.clearSelection() = ClearSelection;
  const factory CartonCodesEvent.refresh() = RefreshCartonCodes;
  const factory CartonCodesEvent.seal(String cartonCodeId, String sealedBy) =
      SealCarton;

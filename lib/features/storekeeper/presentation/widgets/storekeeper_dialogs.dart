...
class CateringItemDialog extends StatefulWidget {
  ...
  const CateringItemDialog({super.key, required this.categories, this.existing});
...
class _CateringItemDialogState extends State<CateringItemDialog> {
  ...
  void initState() {
    ...
    _stockCtrl =
        TextEditingController(text: (e?.stockOnHand ?? 0).toString());
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  const DropdownMenuItem(
                      value: null, child: Text('None', style: TextStyle(color: Colors.white54))),
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'discontinued',
                      child: Text('Discontinued', style: TextStyle(color: Colors.white))),
                ],
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text('Current stock: ${widget.item.stockOnHand} ${widget.item.unit}',
          ...
          Row(
            children: [
              ...
              ChoiceChip(
                label: const Text('Remove', style: TextStyle(color: Colors.white, fontSize: 12)),
                selected: !_add,
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: _submit,
          child: Text(_add ? 'Add Stock' : 'Remove Stock',

// Add Goods Company Screen — Super Admin adds a new goods logistics fleet company
// Pattern follows AddBusCompanyScreen with truck/goods theme
...
/// Add Goods Company Screen — Super Admin registration form for goods logistics fleet companies
class AddGoodsCompanyScreen extends StatefulWidget {
  final bool inShell;

  const AddGoodsCompanyScreen({super.key, this.inShell = false});

  @override
  State<AddGoodsCompanyScreen> createState() => _AddGoodsCompanyScreenState();
}

class _AddGoodsCompanyScreenState extends State<AddGoodsCompanyScreen> {
          ...
          listener: (context, state) {
            if (state is CompanyRegisterSuccess) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Goods company "$name" created successfully!'),
  ...
  Widget _buildContent() {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Add Goods Company')),
      body: body,
    );
  }
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'Register New Goods Company',
                    style: Theme.of(context).textTheme.titleLarge?.copyWith(
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  Text(
                    'Create a goods logistics fleet company account with owner credentials',
                    style: Theme.of(
                      context,
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextField(
          ...
          hintText: 'e.g., TCS Logistics, Leopards Courier',
        ...
        CustomTextField(
          ...
          labelText: 'Address',
          hintText: 'Full office/warehouse address',
        ...
        CustomTextField(
          ...
          labelText: 'Website',
          hintText: 'e.g., https://www.tcs.com.pk',
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextField(
          ...
          hintText: 'owner@goodscompany.com',
  ...
  Widget _fleetSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _sectionHeader('Fleet Details', Icons.local_shipping),
        Gap(16.h),
        Row(
          children: [
            Expanded(
              child: CustomTextField(
                ...
                hintText: 'Total trucks in fleet',
                prefixIcon: const Icon(Icons.local_shipping),
        ...
        CustomTextField(
          ...
          hintText:
              'Brief description of the goods logistics company services...',
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.info, color: AppColors.success, size: 20.w),
              Gap(8.w),
              Expanded(
                child: Text(
                  'A login link will be generated for the goods company owner. '
                  'The owner can log in at /goods-fleet/login using the email '
  ...
  Widget _submitButton() {
    return SizedBox(
      ...
      child: PrimaryButton(
        text: _isSubmitting ? 'Registering...' : 'Register Goods Company',
        onPressed: () {
  ...
  void _submitForm() {
    ...
    // Store goods-specific data in admin_notes as JSON
    final goodsMeta = <String, dynamic>{
      'company_type_tag': 'goods_fleet',
      'truck_count': int.tryParse(_truckCountController.text.trim()) ?? 0,
    ...
    _companyRegisterBloc.add(
      RegisterCompany(
        companyData: {
          ...
          'admin_notes': jsonEncode(goodsMeta),

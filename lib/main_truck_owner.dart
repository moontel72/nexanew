...
void main() async {
  ...
  runApp(const TruckOwnerApp());
}

class TruckOwnerApp extends StatelessWidget {
  const TruckOwnerApp({super.key});
...
final _router = GoRouter(
  ...
  routes: [
    GoRoute(path: '/login', builder: (_, __) => const TruckOwnerLoginScreen()),
    GoRoute(
      path: '/dashboard',
      builder: (_, __) => const TruckOwnerDashboardScreen(),
    ),
  ],
);

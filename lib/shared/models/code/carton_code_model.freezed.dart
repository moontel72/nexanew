...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,code,type,status,factoryId,subscriptionPlanId,storeKeeperCode,internationalCode,batchId,generatedAt,linkedAt,publishedAt,deactivatedAt,productId,productBatchNumber,manufacturingDate,expiryDate,warrantyMonths,qrCodeData,barcodeData,metadata,version,createdAt,updatedAt,isDeleted,bundleCode,packetCount,const DeepCollectionEquality().hash(_packetCodes),weight,dimensions,sequenceNumber,totalUnits,cartonType,grade,maxWeightCapacity,isSealed,sealedAt,sealedBy,temperatureRequirements,handlingInstructions,cartonBarcode,cartonQrCode,codeFormat,condition,lastInspectionDate,inspectionNotes]);

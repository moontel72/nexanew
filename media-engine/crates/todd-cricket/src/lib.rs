...
//! log. Relocated from the legacy `rust/` FFI crate (Phase 0 cleanup) so
//! the media engine (scoreboard overlays, replay triggers, analytics) and
//! the correction engine share one source of truth.
//!
